...
class Permutator
{
    ...
    //checking that the number of cities is not less than 1
    public Permutator(int n, int firstNum_)
    {
        if (n < 1)
        {
...
//takes the nunber of cities and put them into an array
...
//gets the next permutation array
